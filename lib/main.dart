...
import 'package:example/sources/flutter_fast_forms_example.dart';
import 'package:example/sources/flutter_stepper_sample.dart';
import 'package:example/sources/material_app_bar.dart';
    ...
    return CodePage(
      ...
      child: ListView(
        children: <Widget>[
          ...
          const Divider(),
          ListTile(
            title: const Text('Flutter Fast Forms Example'),
            trailing: const Icon(Icons.arrow_right_sharp),
            onTap: () {
              Navigator.of(context).push(
                MaterialPageRoute(
